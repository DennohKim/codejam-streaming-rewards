...
const AddEmployeeModal = () => {
	...
	const EmployeeSalaryInWei = ethers.utils.parseEther(`${debouncedEmployeeSalary.toString() || 0}`)
	...
	const { writeAsync: createEmployee } = useContractSend('captureEmployeeDetails', [
